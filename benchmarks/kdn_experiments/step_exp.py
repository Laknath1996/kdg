...
def getNN():
    ...
    network_base.add(keras.layers.Dense(20, activation="relu", kernel_initializer=initializer, input_shape=(2,)))
    network_base.add(keras.layers.Dense(20, activation="relu", kernel_initializer=initializer))
    network_base.add(keras.layers.Dense(20, activation="relu", kernel_initializer=initializer))
    network_base.add(keras.layers.Dense(20, activation="relu", kernel_initializer=initializer))
...
df.to_csv("results/step.csv")

# plot

#%%
# Specify which results to plot (CHANGE HERE)
filename = "results/step.csv"
...
plt.savefig("plots/step_exp.pdf")
print("Complete!")
